# Premium Auto Detailing - Landing Page Demo
...
*   **Efectos y Animaciones:**
    ...
    *   Efecto de partículas (Canvas) en la sección Hero.
    *   Contadores animados para estadísticas.
    *   Efectos de revelación (ScrollReveal) al desplazarse por la página.
    *   Carrusel de testimonios interactivo (soporta touch/swipe).
*   **Secciones Integradas:**
    *   **Hero:** Impacto visual inicial con estadísticas.
    *   **Servicios:** Grid detallado de tratamientos (Cerámico, Acrílico, Interior, PPF, etc.).
    *   **Portfolio (Galería):** Layout tipo "bento grid" con los autos más populares de Argentina.
    *   **Nosotros:** Información de la empresa y garantías.
    *   **Proceso:** Línea de tiempo con los pasos del servicio.
...
├── assets/
│   ├── css/
│   │   └── styles.css      # Sistema de diseño, variables y estilos responsivos
│   ├── js/
│   │   └── script.js       # Lógica de animaciones, carrusel y UI
│   └── images/
│       └── ...             # Imágenes de los vehículos generadas por IA
